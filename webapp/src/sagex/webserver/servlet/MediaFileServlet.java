...
public class MediaFileServlet extends SageServlet
{
        ...
        throws Exception
    {
        try
        {
            ...
            boolean isRecording = (Boolean) SageTV.api("IsFileCurrentlyRecording", new Object[] {mediaFile});
    		...
    		if (headOnly)
    		{
//    		    System.out.println("Headers only");
    		    res.flushBuffer();
    		}
    		else
    		{
    		    ...
    		    try
    		    {
    		        ...
    		        while (stop == fileLength - 1 || nextByte <= stop)
    		        {
                        ...
                        if (readLen == -1)
                        {
                            ...
                            isRecording = (Boolean) SageTV.api("IsFileCurrentlyRecording", new Object[] {mediaFile});
                            if (isRecording)
                            {
                                files = (File[]) SageTV.api("GetSegmentFiles", new Object[] {mediaFile});
