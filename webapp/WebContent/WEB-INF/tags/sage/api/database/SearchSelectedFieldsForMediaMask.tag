<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/Database.html#SearchSelectedFields(java.lang.String, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, java.lang.String)'>Database.SearchSelectedFields</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "SearchSelectedFields", new Object[] {searchStringAttr, caseSensitiveAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
else
{
    returnVal = sage.SageTV.api("SearchSelectedFields", new Object[] {searchStringAttr, caseSensitiveAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
%>
