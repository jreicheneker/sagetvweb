<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/Database.html#GetFilesWithImportPrefix(java.lang.Object, java.lang.String, boolean, boolean, boolean)'>Database.GetFilesWithImportPrefix</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "GetFilesWithImportPrefix", new Object[] {mediaDataAttr, importPrefixAttr, includeFilesAttr, includeFoldersAttr, groupFoldersAttr});
}
else
{
    returnVal = sage.SageTV.api("GetFilesWithImportPrefix", new Object[] {mediaDataAttr, importPrefixAttr, includeFilesAttr, includeFoldersAttr, groupFoldersAttr});
}
%>
