<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/Database.html#SearchSelectedFieldsRegex(java.util.regex.Pattern, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, java.lang.String)'>Database.SearchSelectedFieldsRegex</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "SearchSelectedFieldsRegex", new Object[] {regexPatternAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
else
{
    returnVal = sage.SageTV.api("SearchSelectedFieldsRegex", new Object[] {regexPatternAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
%>
