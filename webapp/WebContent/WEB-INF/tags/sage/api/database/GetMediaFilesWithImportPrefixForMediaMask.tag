<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/Database.html#GetMediaFilesWithImportPrefix(java.lang.String, java.lang.String, boolean, boolean, boolean)'>Database.GetMediaFilesWithImportPrefix</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "GetMediaFilesWithImportPrefix", new Object[] {mediaMaskAttr, importPrefixAttr, includeFilesAttr, includeFoldersAttr, groupFoldersAttr});
}
else
{
    returnVal = sage.SageTV.api("GetMediaFilesWithImportPrefix", new Object[] {mediaMaskAttr, importPrefixAttr, includeFilesAttr, includeFoldersAttr, groupFoldersAttr});
}
%>
