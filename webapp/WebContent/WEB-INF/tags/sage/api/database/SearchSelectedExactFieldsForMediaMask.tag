<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/Database.html#SearchSelectedExactFields(java.lang.String, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, boolean, java.lang.String)'>Database.SearchSelectedExactFields</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "SearchSelectedExactFields", new Object[] {searchStringAttr, caseSensitiveAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
else
{
    returnVal = sage.SageTV.api("SearchSelectedExactFields", new Object[] {searchStringAttr, caseSensitiveAttr, titlesAttr, episodeAttr, descriptionAttr, peopleAttr, categoryAttr, ratedAttr, extendedRatingsAttr, yearAttr, miscAttr, mediaMaskAttr});
}
%>
