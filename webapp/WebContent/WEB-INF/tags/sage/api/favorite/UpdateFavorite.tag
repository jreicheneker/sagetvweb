<%--
  ...
  -- See Official Sage Documentation at <a href='http://download.sage.tv/api/sage/api/FavoriteAPI.html#UpdateFavorite(sage.Favorite, java.lang.String, boolean, boolean, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)'>FavoriteAPI.UpdateFavorite</a>
...
{
    returnVal = sage.SageTV.apiUI(context, "UpdateFavorite", new Object[] {favoriteAttr, titleAttr, firstRunsAttr, reRunsAttr, categoryAttr, subCategoryAttr, personAttr, roleForPersonAttr, ratedAttr, yearAttr, parentalRatingAttr, networkAttr, channelCallSignAttr, timeslotAttr, keywordAttr});
}
else
{
    returnVal = sage.SageTV.api("UpdateFavorite", new Object[] {favoriteAttr, titleAttr, firstRunsAttr, reRunsAttr, categoryAttr, subCategoryAttr, personAttr, roleForPersonAttr, ratedAttr, yearAttr, parentalRatingAttr, networkAttr, channelCallSignAttr, timeslotAttr, keywordAttr});
}
%>
