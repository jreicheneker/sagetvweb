...
<body>
   ...
   <c:url var="linkUrl" value="${cp}/m/searchairings.jsp">
   ...
   <div class="content">
      ...
      <div class="sectionbody">
         ...
         <form method="get" action="${cp}/m/searchairings.jsp">
            <input type="hidden" name="searchType" value="Airings" />
            ...
            <div class="dividerbody">
               ...
               <div class="label">Occurring</div>
               <div class="value">
                  <select name="timeRange">
                     <option value="-1"<c:if test="${param.timeRange == '-1'}"> selected="selected"</c:if>>Any Time</option>
                     <option value="-999"<c:if test="${param.timeRange == '-999'}"> selected="selected"</c:if>>In the Past</option>
                     <option value="0"<c:if test="${empty param.timeRange or param.timeRange == '0'}"> selected="selected"</c:if>>In the Future</option>
                     <option value="24"<c:if test="${param.timeRange == '24'}"> selected="selected"</c:if>>Within 24 hrs</option>
                     <option value="48"<c:if test="${param.timeRange == '48'}"> selected="selected"</c:if>>Within 48 hrs</option>
                     <option value="120"<c:if test="${param.timeRange == '120'}"> selected="selected"</c:if>>Within 5 days</option>
                     <option value="168"<c:if test="${param.timeRange == '168'}"> selected="selected"</c:if>>Within 1 week</option>
                     <option value="336"<c:if test="${param.timeRange == '336'}"> selected="selected"</c:if>>Within 2 weeks</option>
                  </select>
               </div>
            ...
            <div class="sectionbody"--%>
               <button type="submit" value="Search">Search Airings</button>
            <%--/div--%>
         </form>
      </div>
